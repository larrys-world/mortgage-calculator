 ...
 */
export const HeaderAd: React.FC<Omit<AdSenseAdProps, 'format'>> = ({ client, slot, ...props }) => (
  <AdSenseAd
    client={client}
    slot={slot}
    format="horizontal"
 ...
 */
export const SidebarAd: React.FC<Omit<AdSenseAdProps, 'format'>> = ({ client, slot, ...props }) => (
  <AdSenseAd
    client={client}
    slot={slot}
    format="rectangle"
 ...
 */
export const FooterAd: React.FC<Omit<AdSenseAdProps, 'format'>> = ({ client, slot, ...props }) => (
  <AdSenseAd
    client={client}
    slot={slot}
    format="horizontal"
 ...
 */
export const InContentAd: React.FC<Omit<AdSenseAdProps, 'format'>> = ({ client, slot, ...props }) => (
  <AdSenseAd
    client={client}
    slot={slot}
    format="fluid"
